...
class ali_translator():
    def __init__(self, key_id='', key_id_secret='', from_lang='ja', to_lang='zh', write_log=False):
    ...
    def query(self, text, log_file='D:\.ali_trans_log.txt'):
        ...
        #print(f"trans len is {len(translation)}")
        #print(translation)
